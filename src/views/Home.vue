  ...
  <div>
    <v-container>
      <v-row justify="center">
        ...
        >
          <p
            :class="['text--secondary text-center mb-5 mb-sm-10', size.smAndUp ? 'display-3' : 'display-1']"
            align-self
          >Browse Public Songs</p>
          <v-text-field
            ...
            <v-list v-if="!publicSongListLoading">
              <v-scroll-x-transition group hide-on-leave>
                ...
                <component
                  ...
                  :key="group.group"
                  :prepend-icon="filters.groupByAuthor? 'mdi-account-circle-outline' : ''"
                >
                          ...
                          <template v-slot:activator="{ on, attrs }">
                            <v-fab-transition hide-on-leave>
                              <v-btn
                                ...
                                :disabled="!userLogged || alreadyInCollection(song.id)"
                                fab
                                x-small
